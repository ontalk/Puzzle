...
public class Player2 : MonoBehaviour
{
    ...
    {
        if (Input.GetButtonDown("KeyBoardHorizontal"))
            spriteRenderer.flipX = Input.GetAxisRaw("KeyBoardHorizontal") == -1f;
    }
    private void Move()
    {

        Horizontal_Move = Input.GetAxisRaw("KeyBoardHorizontal"); // 수평 입력 (좌우)
